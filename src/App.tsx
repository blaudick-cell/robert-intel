...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1117] text-zinc-200">
      {/* Top Navigation */}
      <nav className="border-b border-zinc-800/60 bg-[#0f1117]/95 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-x-3">
              <div className="flex items-center gap-x-3">
                <div className="w-9 h-9 bg-teal-500 rounded-2xl flex items-center justify-center shadow-lg shadow-teal-500/20">
                  <Compass className="w-5 h-5 text-[#0f1117]" />
                </div>
                <div>
                  <span className="font-semibold text-2xl tracking-tighter">Robert</span>
                  <span className="ml-1.5 text-teal-400 font-mono text-sm align-super">INTEL</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-x-8 text-sm">
              <div className="flex items-center gap-x-2 text-zinc-400 text-xs">
                ...
                <span>Last updated <span className="font-mono text-teal-400">{lastUpdated}</span></span>
              </div>
      ...
      <div className="max-w-screen-2xl mx-auto px-8 py-10">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-x-3 mb-4">
            <div className="uppercase text-teal-400 text-xs font-semibold tracking-[1.5px]">Daily Briefing</div>
            <div className="flex-1 h-px bg-gradient-to-r from-teal-900/40 to-transparent"></div>
          </div>
            ...
            <div className="grid grid-cols-12 gap-8">
                ...
                <div className="flex items-start gap-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-5 flex items-center gap-x-3">
                      <div className="px-4 py-1 bg-teal-950 text-teal-400 rounded-2xl text-xs font-medium tracking-wide">3 NEW ITEMS</div>
                      <div className="text-teal-400 text-sm font-medium cursor-pointer hover:underline flex items-center gap-x-1 group">
                        View full briefing 
              ...
              <div className="col-span-12 lg:col-span-5 border-t lg:border-t-0 lg:border-l border-zinc-800 pt-6 lg:pt-0 lg:pl-8">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between items-center"><span className="text-zinc-400">Market movement</span> <span className="text-teal-400 font-semibold">+2.4%</span></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7">
            <div className="flex items-center justify-between mb-4 px-1">
              <div className="uppercase text-teal-400 text-xs font-semibold tracking-[1.5px]">Opportunities</div>
              <div className="text-xs text-teal-400 font-medium cursor-pointer hover:underline">View all →</div>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div className="font-mono text-3xl font-semibold text-teal-400 tabular-nums">92</div>
                    <div className="text-[10px] text-teal-400/70 -mt-1 tracking-widest">SCORE</div>
                  </div>
                </div>
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div className="font-mono text-3xl font-semibold text-teal-400 tabular-nums">81</div>
                    <div className="text-[10px] text-teal-400/70 -mt-1 tracking-widest">SCORE</div>
                  </div>
                </div>
                <div className="mt-5 flex items-center gap-x-2 text-xs">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center justify-between mb-4 px-1">
              <div className="uppercase text-teal-400 text-xs font-semibold tracking-[1.5px]">News Feed</div>
              <div className="text-xs text-teal-400 font-medium cursor-pointer hover:underline">All news →</div>
            </div>
            
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 space-y-5 text-[15px]">
              <div className="border-l-2 border-teal-900 pl-4">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center justify-between mb-4 px-1">
              <div className="uppercase text-teal-400 text-xs font-semibold tracking-[1.5px]">Market Watch</div>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <div className="text-teal-400 text-xs mt-0.5 font-medium">+0.8%</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-teal-400 text-xs mt-0.5 font-medium">+1.9%</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            <div className="flex items-center justify-between mb-4 px-1">
              <div className="uppercase text-teal-400 text-xs font-semibold tracking-[1.5px]">This Week</div>
            </div>
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
                ...
                <div className="text-teal-400 text-xs mt-2 font-medium">+9 since Monday</div>
              </div>
              <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
                ...
                <div className="text-teal-400 text-xs mt-2 font-medium">-3m from last week</div>
              </div>
              <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
